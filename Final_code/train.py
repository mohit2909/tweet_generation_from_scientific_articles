...
def add_arguments(parser):
    parser.add_argument("--num_hidden", type=int, default=100, help="Network size.")
    parser.add_argument("--num_layers", type=int, default=1, help="Network depth.")
    parser.add_argument("--beam_width", type=int, default=4, help="Beam width for beam search decoder.")
    ...
    parser.add_argument("--keep_prob", type=float, default=0.6, help="Dropout keep prob.")
...
print old_model_checkpoint_path
